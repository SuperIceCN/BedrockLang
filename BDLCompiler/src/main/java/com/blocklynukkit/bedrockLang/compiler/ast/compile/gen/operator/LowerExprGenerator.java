...
public final class LowerExprGenerator implements ExprCodeGenerator, BoxHelper {
    private final LowerExpr expr;

    public LowerExprGenerator(LowerExpr expr) {
        this.expr = expr;
    }
    ...
    public ValueType generate(Unit unit) {
        ...
        if ((isNumberType(leftValueType) && isNumberType(rightValueType)) ||
            ...
            if ((isBoxType(leftValueType) && isNumberType(rightValueType)) ||
                ...
                mv.visitJumpInsn(IFLT, trueLabel); // 小于零
